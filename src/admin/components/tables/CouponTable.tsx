...
import { Pagination, SkeletonTable, useColumnsCoupons } from '..';
...
export const CouponTable = () => {
    ...
    const columns = useColumnsCoupons();

    const { startOnCloseModalCoupon, startSetModalCouponOptions } =
        useCouponStore();

    const toggleModal = () => {
        startSetModalCouponOptions({ title: 'Agregar Coupon' });
        startOnCloseModalCoupon();
    };

    const table = useReactTable({
        data: couponData ?? defaultData,
        columns: columns,
    ...
    return (
        <>
            ...
            <Pagination<Coupon> table={table} isFetching={isFetching} />
        </>
    );
};
