...
import { ProductRequest } from '../../../store';
...
export const CreateProduct = () => {
    const { isFetching, isLoading, data: categories } = useCategories();

    const { startCreate, isLoadingCreate } = useProductMutations();

    const onSubmit = async (value: ProductRequest) => {
        startCreate(value);
    };
            ...
            {({ handleChange, setFieldValue, values, dirty }) => (
                <Form className='flex flex-col gap-3' autoComplete='off'>
                                    ...
                                    {options?.length ? (
                                        <div className='animate__animated animate__fadeIn'>
                                            ...
                                            <p className='text-center dark:text-white text-xs'>
                                                Esta categoría indica que tienes
                                                que añadir opciones para que el
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <button
                            disabled={!dirty || isLoadingCreate}
                            type='submit'
                            ...
                            {isLoadingCreate ? (
                                <Spinner className='w-5 h-5' mini={true} />
                            ) : (
                                'Create Product'
                            )}
                        </button>
